...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        // OpCode::new(0xCB, "IGN", 3,4 , AddressingMode::Absolute_X),
        ...
        OpCode::new(0x93, "*AHX", 2, 8, AddressingMode::Indirect_Y), //todo: highly unstable and not used
        OpCode::new(0x9f, "*AHX", 3, 4, AddressingMode::Absolute_Y), //todo: highly unstable and not used
        OpCode::new(0x9e, "*SHX", 3, 4, AddressingMode::Absolute_Y), //todo: highly unstable and not used
        OpCode::new(0x9c, "*SHY", 3, 4, AddressingMode::Absolute_X), //todo: highly unstable and not used
